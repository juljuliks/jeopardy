module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('Choices', [
      ...
      {
        questionId: 50,
        choiceBody: 'Обычно каждые 100мс, но возможно, что вызовы будут происходить гораздо реже',
        isCorrect: true,
      },
      ...
      {
        questionId: 57,
        choiceBody: 'Да. React.js распространяет событие на все дерево компонентов, и они вызывают метод render.',
      },
      {
        questionId: 57,
      ...
      {
        questionId: 59,
        choiceBody: 'Процесс подъема состояния изменившегося компонента до ближайшего общего предка, чтобы обновить необходимые компоненты',
        isCorrect: true,
      },
      {
        questionId: 59,
      ...
      {
        questionId: 60,
        choiceBody: 'Это хранилище ключ-значение всех props, переданных дочерним компонентам.',
      },
      {
        questionId: 60,
        choiceBody: 'Это переменная, которая содержит ссылки на дочерние компоненты.',
      },
      {
        questionId: 60,
        choiceBody: 'Это переменная, которая содержит содержимое между открывающим и закрывающим тегами компонента.',
        isCorrect: true,
      },
